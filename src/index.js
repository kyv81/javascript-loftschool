 ...
 * @param {function} fn - обработчик
 */
const removeListener = (eventName, target, fn) => target.removeEventListener(eventName, fn);
 ...
 */
const delegate = (target, fn) => target.addEventListener('click', e => e.target.tagName === 'BUTTON' ? fn() : false);
