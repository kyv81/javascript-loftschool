...
const loadingTowns = () => {
    townsPromise
        ...
        () => {
            loadingBlock.textContent='Загрузка городов завершилась неудачно';
            loadingBlock.innerHTML += '<br><button id="btn">Перезагрузка</button>';
            let btn = homeworkContainer.querySelector('#btn');
